...
We'd love for you to contribute to our source code and to make Wobble even better than it is
today!
...
If you have questions about how to contribute to Wobble, please join our [Discord](https://discord.gg/nJa8VFr) server.
...
* Search [GitHub](https://github.com/Swan/Wobble/pulls) for an open or closed Pull Request
...
* Set a new remote [upstream](https://help.github.com/articles/configuring-a-remote-for-a-fork/) (this helps to keep your fork up to date)
    ...
    ```shell
    git remote add upstream https://github.com/Swan/Wobble.git
    ```
...
In GitHub, send a pull request to `Wobble:master`.
If we suggest changes, then:

* Make the required updates.
* Re-run Wobble and make sure any and all tests are still passing.
...
To ensure consistency throughout the source code, review our [CODE STYLE](https://github.com/Swan/Wobble/blob/master/CODESTYLE.md).


[gi
thub]: https://github.com/Swan/Wobble
