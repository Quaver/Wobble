    ...
    public class SelectionScreenView : ScreenView
    {
        ...
        private void CreateSelectionButtons()
        {
            ...
            foreach (var testScreens in screen.TestCasesScreens)
            {
                ...
                var button = new TextButton(WobbleAssets.WhiteBox, "exo2-medium", testScreens.Value, 16)
                {
                    Parent = Container,
                    Size = ButtonSize,
                    Text =
                ...
                switch (testScreens.Key)
                {
                    ...
                    case ScreenType.SpriteAlphaMaskingBlend:
                        ...
                        break;
                    case ScreenType.SpriteTextPlusLine:
                        button.Clicked += (o, e) => ScreenManager.ChangeScreen(new TestSpriteTextPlusLineScreen());
                        break;
