...
namespace Wobble.Tests.Screens.Tests.Scrolling
{
    public class TestScrollContainerScreenView : ScreenView
    {
        ...
        public TestScrollContainerScreenView(Screen screen) : base(screen)
        {
            ...
            ScrollContainer.AddContainedDrawable(new SpriteText("inter-regular", "I love eggplants.", 12)
            {
                Alignment = Alignment.MidCenter,
                Tint = Color.Purple
            });

            var testText = new SpriteText("inter-regular", "This should be clipped off-screen!", 12)
            {
